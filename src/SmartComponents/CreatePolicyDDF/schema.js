          ...
          fields: [
            {
              ...
              validate: [makeStepValidityValidator('Profile selection validation failed')],
            },
          ],
        },
        {
          ...
          fields: [
            {
              ...
              validate: [makeStepValidityValidator('Policy name validation pending or failed')],
            },
          ],
        },
        {
          ...
          fields: [
            {
              ...
              name: 'rules-content',
              validate: [makeStepValidityValidator('Rules selection validation failed')],
            },
          ],
        },
        {
