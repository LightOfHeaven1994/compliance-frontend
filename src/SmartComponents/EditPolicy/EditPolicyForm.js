  ...
  return (
    <Form>
      <RoutedTabs ouiaId="EditPolicy" defaultTab="details">
        <Tab eventKey="details" ouiaId="Details" title={<TabTitleText>Details</TabTitleText>}>
        ...
        <Tab eventKey="rules" ouiaId="Rules" title={<TabTitleText>Rules</TabTitleText>}>
          <EditPolicyRulesTab
            policy={policy}
        ...
        <Tab eventKey="systems" ouiaId="Systems" title={<TabTitleText>Systems</TabTitleText>}>
